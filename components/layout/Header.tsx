...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full max-h-[10dvh] border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
